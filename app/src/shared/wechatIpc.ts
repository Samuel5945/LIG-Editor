...
import type { WechatSettings, PushDraftResult } from './wechat'

export type { WechatSettings, PushDraftResult } from './wechat'

// IpcApi 模块增强：三个公众号通道并入单一契约来源（types.ts 冻结，不直接改）
